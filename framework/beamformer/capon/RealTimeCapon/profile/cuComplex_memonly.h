...
#else
    cuFloatComplex a = make_cuFloatComplex(x.x, y.x);
    cuFloatComplex b = make_cuFloatComplex(x.y, y.y);
    return make_cuFloatComplex (x.x, y.y);
#endif
}
                                                              ...
                                                              cuFloatComplex y)
{
    ...
    cuFloatComplex a = make_cuFloatComplex(x.x, y.x);
    cuFloatComplex b = make_cuFloatComplex(x.y, y.y);
    cuFloatComplex c = make_cuFloatComplex(x.x, y.y);
    cuFloatComplex d = make_cuFloatComplex(x.y, y.x);

    cuFloatComplex e = make_cuFloatComplex(a.x, b.y);
    cuFloatComplex f = make_cuFloatComplex(c.y, d.x);

    return make_cuFloatComplex (e.x, f.y);
#endif
}
                                                             ...
                                                             cuDoubleComplex y)
{
    ...
    return make_cuDoubleComplex (cuCreal(x) + cuCreal(y), 
                                 cuCimag(x) + cuCimag(y));
#else
    cuDoubleComplex a = make_cuDoubleComplex(x.x, y.x);
    cuDoubleComplex b = make_cuDoubleComplex(x.y, y.y);
    return make_cuDoubleComplex (a.x, b.y);
#endif
}
...
__host__ __device__ static __inline__  cuComplex cuCfmaf( cuComplex x, cuComplex y, cuComplex d)
{
    ...
    return make_cuComplex(xx+d.x, yy);
#endif
}
